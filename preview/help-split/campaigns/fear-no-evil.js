...
(function (global) {
  ...
  global.registerCampaign({
    ...
    helpDe: [
      "Jede Runde werden zwei Szenarien gezogen, die weder abgeschlossen noch gescheitert sind; beide erhalten einen Fortschrittspunkt. „Nächste Runde“ macht genau das mit einem Klick und nennt anschließend die gezogenen Szenarien; ist nur noch eines im Spiel, bekommt es beide Punkte.",
      "Der dritte Punkt bedeutet, dass das Szenario gescheitert ist. Deshalb sind „1“, „2“ und „Gescheitert“ ein Zähler und keine drei einzelnen Kästchen — ein Klick auf das jeweils oberste gefüllte Kästchen nimmt einen Punkt zurück.",
      "„Abgeschlossen“ und „Gescheitert“ schließen einander aus: ein abgeschlossenes Szenario friert seinen Fortschritt ein, ein gescheitertes sperrt den Abgeschlossen-Haken.",
      "Jeder der fünf Schurken gehört genau einem Szenario. Ein gewählter Schurke verschwindet aus den übrigen Zeilen und wird in der Schurkenliste durchgestrichen; der Würfel neben einem leeren Schurken-Feld lost einen der noch freien aus.",
    ],
    helpEn: [
      "Each round two scenarios that are neither completed nor failed are drawn, and both take one progress point. “Next round” does exactly that in one click and then names the scenarios it drew; if only one is still in play it takes both points.",
      "The third point means the scenario has failed. So “1”, “2” and “Failed” are one counter rather than three separate boxes — clicking the topmost filled box takes a point back.",
      "“Completed” and “Failed” are mutually exclusive: a completed scenario freezes its progress, and a failed one locks the Completed box.",
      "Each of the five villains belongs to exactly one scenario. A chosen villain disappears from the other rows and is struck through in the villain list; the die beside an empty villain field rolls one of those still free.",
    ],
