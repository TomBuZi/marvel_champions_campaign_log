...
window.I18N = {
  de: {
    ...
    helpDeckP: "Ins Identitätsfeld darf statt eines Heldennamens auch ein Deck von MarvelCDB — die Kennung („1213577“) oder der ganze Link. Der Bogen merkt sich die Kennung, zeigt darunter einen Link auf das Deck und trägt den Helden ein, den er dort findet. Das ist der einzige Netzwerkzugriff der App: dabei geht die Deck-Kennung an marvelcdb.com, sonst nichts. Ohne Netz, bei einem privaten Deck oder einer falschen Kennung bleibt der Link trotzdem stehen, nur der Name muss dann selbst getippt werden. Und ein Heldenname oder beliebiger Freitext geht nach wie vor.",
    helpListsH: "Listen",
  ...
  en: {
    ...
    helpDeckP: "The identity field also takes a MarvelCDB deck instead of a hero name — the id (“1213577”) or the whole link. The sheet keeps the id, shows a link to the deck below the field and fills in the hero it finds there. This is the only network access the app makes: the deck id goes to marvelcdb.com, nothing else does. Without a network, for a private deck or a wrong id the link still stands; only the name has to be typed by hand. And a hero name or any free text works exactly as before.",
    helpListsH: "Lists",
