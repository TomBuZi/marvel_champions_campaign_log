...
window.I18N = {
  ...
  en: {
    ...
    helpDeckP: "The identity field also takes a MarvelCDB deck instead of a hero name — the id (“1213577”) or the whole link. The sheet keeps the id, shows a link to the deck below the field and fills in the hero it finds there. While a deck is linked the field is locked — the hero comes from there; the × on the link gives it back. This is the only network access the app makes: the deck id goes to marvelcdb.com, nothing else does. Without a network, for a private deck or a wrong id the link still stands; the name is then typed by hand, once the link has been cleared with the ×. And a hero name or any free text works exactly as before.",
    helpListsH: "Lists",
